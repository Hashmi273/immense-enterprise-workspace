...
import { Terminal, FileText, Building2, ArrowUpRight, Shield, Sparkles, Lock } from "lucide-react";
      ...
      <div className="glass-card-navy text-white rounded-3xl p-8 sm:p-10 shadow-glow relative overflow-hidden border border-white/10">
        ...
        <div className="relative z-10 max-w-2xl">
          <div className="inline-flex items-center space-x-2 px-3 py-1 rounded-full bg-white/10 text-brand-cyan text-xs font-semibold uppercase tracking-wider mb-4 border border-white/10">
            ...
            <span>Immense Enterprise Portal</span>
          </div>
          <h1 className="text-3xl sm:text-4xl font-extrabold tracking-tight text-white leading-tight">
            Welcome to the Central Workspace
          </h1>
          <p className="mt-3 text-slate-300 text-sm sm:text-base leading-relaxed">
            Secure launchpad for Immense Air and Zion enterprise tools. Access is strictly controlled by your authenticated organization and role.
          </p>
        </div>
      </div>
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-xs text-slate-500 mt-0.5">
              Available tools for your account and entity assignment
            </p>
          </div>
          <div className="hidden sm:flex items-center space-x-2 text-xs text-slate-500 bg-white px-3 py-1.5 rounded-xl border border-slate-200 shadow-sm">
              ...
              >
                ...
                <div className="pt-6 mt-6 border-t border-slate-100 flex items-center justify-between">
                  <span className="text-xs text-slate-400 flex items-center space-x-1">
                    ...
                    <span>Database RLS Enforced</span>
                  </span>
                  <Link
                    to={app.route}
