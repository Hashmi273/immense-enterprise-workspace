...
export function ImmenseQuotesApp() {
  ...
  const handleNewQuotation = () => {
    ...
    fresh.client.proposalNumber = `IA/${new Date().getFullYear()}/${randomSeq}`;
    setData(fresh);
        ...
        <div className="mx-auto flex max-w-[1600px] flex-wrap items-center justify-between gap-4 px-5 py-3">
          <div className="flex items-center space-x-3">
            ...
            <div className="flex items-center space-x-2.5">
              <span className="flex h-8 w-8 items-center justify-center rounded-lg bg-navy text-xs font-bold text-white shadow-sm">
                IA
              </span>
              <div>
                <h1 className="text-sm font-bold text-navy leading-tight flex items-center gap-2">
                  <span>Immense Air Quotation Manager</span>
                  <span className="text-[10px] font-semibold bg-emerald-100 text-emerald-800 px-2 py-0.5 rounded-full">
                    Live
                  </span>
                </h1>
                <p className="text-[11px] text-brand-ink/60">
                  {organization?.name || "Immense Air Pvt Ltd"} &middot; High-Fidelity A4 Proposals
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center space-x-3">
            ...
            <button
              ...
              className={`inline-flex items-center space-x-1.5 px-4 py-1.5 text-xs font-bold text-white rounded-lg transition-all shadow-panel ${
                isDirty
                  ? "bg-[#f2591f] hover:bg-[#d94a15] animate-pulse"
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-brand-ink/60">
                Saved proposals for {organization?.name || "Immense Air"} protected by PostgreSQL RLS.
              </p>
            </div>
            <button
              type="button"
